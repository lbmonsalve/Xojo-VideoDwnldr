...
Inherits TestGroup
	...
	#tag Method, Flags = &h0
		Sub SyncDownloaderTest()
		  Dim file As FolderItem= FindFile("cacert-2022-07-19.pem", "ca-cert")
		  
		  Dim fd As VideoDl.IFileDownloader= New MockFileDownloader(file)
		  fd.SetProgressAction(WeakAddressOf MockProgress)
		  fd.SetCompletedAction(WeakAddressOf MockCompleted)
		  fd.Start
