...
Inherits Application
	...
	#tag Constant, Name = kEditCut, Type = String, Dynamic = True, Default = \"Cu&t", Scope = Public
		#Tag Instance, Platform = Any, Language = es, Definition  = \"Cor&tar"
	#tag EndConstant
	...
	#tag Constant, Name = kEditSelectAll, Type = String, Dynamic = True, Default = \"Sellect &all", Scope = Public
		#Tag Instance, Platform = Any, Language = es, Definition  = \"Seleccion&ar Todo"
	#tag EndConstant

	#tag Constant, Name = kEditUndo, Type = String, Dynamic = True, Default = \"&Undo", Scope = Public
		#Tag Instance, Platform = Any, Language = es, Definition  = \"Des&hacer"
	#tag EndConstant
	...
	#tag Constant, Name = kFileQuitShortcut, Type = String, Dynamic = False, Default = \"", Scope = Public
		#Tag Instance, Platform = Any, Language = Default, Definition  = \"Cmd+Q"
